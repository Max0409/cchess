...
from cchesslib.lookup import Winner
import codecs
...
class Chessboard:
    ...
    @property
    def chessmans_table(self):
        return self.__chessmans_table
    ...
    def init_board(self):
        ...
        red_rook_left.put_on_chessboard(0, 0)
        red_rook_right = Rook(u" 车r红 ", "red_rook_right", True, self, 'R')
        red_rook_right.put_on_chessboard(8, 0)
        black_rook_left = Rook(u" 车l黑 ", "black_rook_left", False, self, 'r')
        black_rook_left.put_on_chessboard(0, 9)
        black_rook_right = Rook(u" 车r黑 ", "black_rook_right", False, self, 'r')
        black_rook_right.put_on_chessboard(8, 9)
        red_knight_left = Knight(u" 马l红 ", "red_knight_left", True, self, 'K')
        red_knight_left.put_on_chessboard(1, 0)
        red_knight_right = Knight(u" 马r红 ", "red_knight_right", True, self, 'K')
        red_knight_right.put_on_chessboard(7, 0)
        black_knight_left = Knight(u" 马l黑 ", "black_knight_left", False, self,
                                   'k')
        black_knight_left.put_on_chessboard(1, 9)
        black_knight_right = Knight(u" 马r黑 ", "black_knight_right", False, self,
                                    'k')
        black_knight_right.put_on_chessboard(7, 9)
        red_cannon_left = Cannon(u" 炮l红 ", "red_cannon_left", True, self, 'C')
        red_cannon_left.put_on_chessboard(1, 2)
        red_cannon_right = Cannon(u" 炮r红 ", "red_cannon_right", True, self, 'C')
        red_cannon_right.put_on_chessboard(7, 2)
        black_cannon_left = Cannon(u" 炮l黑 ", "black_cannon_left", False, self,
                                   'c')
        black_cannon_left.put_on_chessboard(1, 7)
        black_cannon_right = Cannon(u" 炮r黑 ", "black_cannon_right", False, self,
                                    'c')
        black_cannon_right.put_on_chessboard(7, 7)
        red_elephant_left = Elephant(u" 相l红 ", "red_elephant_left", True, self,
                                     'E')
        red_elephant_left.put_on_chessboard(2, 0)
        red_elephant_right = Elephant(u" 相r红 ", "red_elephant_right", True,
                                      self, 'E')
        red_elephant_right.put_on_chessboard(6, 0)
        black_elephant_left = Elephant(u" 象l黑 ", "black_elephant_left", False,
                                       self, 'e')
        black_elephant_left.put_on_chessboard(2, 9)
        black_elephant_right = Elephant(u" 象r黑 ", "black_elephant_right", False,
                                        self, 'e')
        black_elephant_right.put_on_chessboard(6, 9)
        red_mandarin_left = Mandarin(u" 仕l红 ", "red_mandarin_left", True, self,
                                     'M')
        red_mandarin_left.put_on_chessboard(3, 0)
        red_mandarin_right = Mandarin(u" 仕r红 ", "red_mandarin_right", True,
                                      self, 'M')
        red_mandarin_right.put_on_chessboard(5, 0)
        black_mandarin_left = Mandarin(u" 仕l黑 ", "black_mandarin_left", False,
                                       self, 'm')
        black_mandarin_left.put_on_chessboard(3, 9)
        black_mandarin_right = Mandarin(u" 仕r黑 ", "black_mandarin_right", False,
                                        self, 'm')
        black_mandarin_right.put_on_chessboard(5, 9)
        red_king = King(u" 帅 红 ", "red_king", True, self, 'S')
        red_king.put_on_chessboard(4, 0)
        black_king = King(u" 将 黑 ", "black_king", False, self, 's')
        black_king.put_on_chessboard(4, 9)
        red_pawn_1 = Pawn(u" 兵1红 ", "red_pawn_1", True, self, 'P')
        red_pawn_1.put_on_chessboard(0, 3)
        red_pawn_2 = Pawn(u" 兵2红 ", "red_pawn_2", True, self, 'P')
        red_pawn_2.put_on_chessboard(2, 3)
        red_pawn_3 = Pawn(u" 兵3红 ", "red_pawn_3", True, self, 'P')
        red_pawn_3.put_on_chessboard(4, 3)
        red_pawn_4 = Pawn(u" 兵4红 ", "red_pawn_4", True, self, 'P')
        red_pawn_4.put_on_chessboard(6, 3)
        red_pawn_5 = Pawn(u" 兵5红 ", "red_pawn_5", True, self, 'P')
        red_pawn_5.put_on_chessboard(8, 3)
        black_pawn_1 = Pawn(u" 卒1黑 ", "black_pawn_1", False, self, 'p')
        black_pawn_1.put_on_chessboard(0, 6)
        black_pawn_2 = Pawn(u" 卒2黑 ", "black_pawn_2", False, self, 'p')
        black_pawn_2.put_on_chessboard(2, 6)
        black_pawn_3 = Pawn(u" 卒3黑 ", "black_pawn_3", False, self, 'p')
        black_pawn_3.put_on_chessboard(4, 6)
        black_pawn_4 = Pawn(u" 卒4黑 ", "black_pawn_4", False, self, 'p')
        black_pawn_4.put_on_chessboard(6, 6)
        black_pawn_5 = Pawn(u" 卒5黑 ", "black_pawn_5", False, self, 'p')
        black_pawn_5.put_on_chessboard(8, 6)
        self.calc_chessmans_moving_list()

    def put_on_chessman(self, chessman: Chessman, col_num: int, row_num: int):
        self.chessmans[col_num][row_num] = chessman
        if chessman.name_en not in self.__chessmans_table:
            self.__chessmans_table[chessman.name_en] = chessman

    def remove_chessman_target(self, col_num: int, row_num: int):
        chessman_old = self.get_chessman(col_num, row_num)
        if chessman_old != None:
            self.__chessmans_table.pop(chessman_old.name_en)
            chessman_old.is_alive = False
        return chessman_old

    def remove_chessman_source(self, col_num: int, row_num: int):
        self.chessmans[col_num][row_num] = None

    def calc_chessmans_moving_list(self):
        for chessman in self.__chessmans_table.values():
    ...
    def get_chessman(self, col_num: int, row_num: int) -> Chessman:
        return self.__chessmans[col_num][row_num]

    def get_chessman_by_name(self, name: str):
        if name in self.__chessmans_table:
            return self.__chessmans_table[name]

    def get_top_first_chessman(self, col_num: int, row_num: int):
        for i in range(row_num + 1, 10, 1):
            current = self.chessmans[col_num][i]
            if current != None:
                return current

    def get_bottom_first_chessman(self, col_num: int, row_num: int):
        for i in range(row_num - 1, -1, -1):
            current = self.chessmans[col_num][i]
            if current != None:
                return current

    def get_left_first_chessman(self, col_num: int, row_num: int):
        for i in range(col_num - 1, -1, -1):
            current = self.chessmans[i][row_num]
            if current != None:
                return current

    def get_right_first_chessman(self, col_num: int, row_num: int):
        for i in range(col_num + 1, 9, 1):
            current = self.chessmans[i][row_num]
            if current != None:
                return current

    def get_top_second_chessman(self, col_num: int, row_num: int):
        count = 0
        for i in range(row_num + 1, 10, 1):
            current = self.chessmans[col_num][i]
            if current != None:
    ...
    def get_bottom_second_chessman(self, col_num: int, row_num: int):
        count = 0
        for i in range(row_num - 1, -1, -1):
            current = self.chessmans[col_num][i]
            if current != None:
    ...
    def get_left_second_chessman(self, col_num: int, row_num: int):
        count = 0
        for i in range(col_num - 1, -1, -1):
            current = self.chessmans[i][row_num]
            if current != None:
    ...
    def get_right_second_chessman(self, col_num: int, row_num: int):
        count = 0
        for i in range(col_num + 1, 9, 1):
            current = self.chessmans[i][row_num]
            if current != None:
    ...
    def print_to_cl(self, is_print=True) -> None:
        screen = "\r\n"
            ...
            for j in range(10):
                ...
                if chess != None:
                    ...
                    if chess != None and chess.is_red != self.__is_red_turn:
                        if chess.in_moving_list(king.position.x,
                                                king.position.y):
            ...
            for j in range(10):
                ...
                if chess != None:
                    if chess.position.x != self.chessmans_hash[chess.name].position.x or\
                        ...
                        print("Error position:", chess.name, chess.position.x,
                              chess.position.y)

    def make_record(self, chess: Chessman, old_x: int, old_y: int, x: int,
                    y: int):
        if self.__is_red_turn:
            if self.turns != 1:
                self.record += '\n'
        ...
        # vertical move
            ...
            if not has_two:
                if not self.is_red_turn:
                    ...
                    self.record += RECORD_NOTES[9 - old_x][1]
            if (y > old_y and self.is_red_turn) or (y < old_y and
                                                    not self.is_red_turn):
                self.record += u'进'
            else:
                self.record += u'退'
    ...
    def save_record(self, filename: str, head=''):
...
RECORD_NOTES = [['0', '0'], ['1', u'一'], ['2', u'二'], ['3', u'三'], ['4', u'四'],
