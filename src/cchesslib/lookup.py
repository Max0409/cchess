        ...
        for l1 in range(9):
            destinations = [(n1, t) for t in range(9)] + [
                (t, l1) for t in range(10)
                 ...
                 for (a, b) in [(-2, -1), (-1, -2), (-2, 1), (1, -2), (2, -1),
                                (-1, 2), (2, 1), (1, 2)]]
...
def move_to_str(x: int, y: int, x_: int, y_: int) -> str:
    move_str = ''
    move_str += str(x)
    move_str += str(y)
    move_str += str(x_)
